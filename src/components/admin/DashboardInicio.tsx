    ...
    <div className="w-full">
      ...
      <div className="mb-6">
        <p className="text-gray-500 text-sm mb-1 font-medium">
          Administración <span className="mx-1 font-normal">&gt;</span> <span className="font-semibold text-gray-800 dark:text-gray-200">General</span>
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-[#1e293b] dark:text-white">22</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-[#1e293b] dark:text-white">15</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-[#1e293b] dark:text-white">7</p>
          </div>
        </div>
      </div>
