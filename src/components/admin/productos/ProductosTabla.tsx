...
const BtnAñadirDatos = ({
    ...
    const enviarDatos = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const url = productoEditar
            ? `https://apitami.tami-peru.com/api/v1/productos/${productoEditar.id}`
            : "https://apitami.tami-peru.com/api/v1/productos";
        ...
        try {
            const respuesta = await fetch(url, {
                ...
                body: JSON.stringify({
                    ...
                    relacionados: [
                        formulario.productos_relacionados,
                        2,
                        3
                    ]
                })
            ...
            {isOpen && (
                <div className="fixed inset-0 flex items-start justify-center bg-black/50 overflow-y-auto py-10">
                    <div className="bg-teal-600 text-white px-10 py-8 rounded-4xl w-3/5">
                        ...
                        {/* Formulario */}
                        <form id="eliminentechno3" onSubmit={enviarDatos} className="grid grid-cols-4 gap-4 gap-x-12">
                            ...
                            <div className="col-span-2">
                                ...
                                <input
                                    type="text" name="subtitulo" required
                            ...
                            <div className="col-span-4">
                                ...
                                <textarea name="descripcion" rows={1} required
                                          value={formulario.descripcion}
                                          onChange={handleChange}
                                          className="w-full bg-white p-2 outline-none rounded-md text-black"></textarea>
                            </div>

                            <div className="col-span-2">
                                <label className="block">Imagen principal</label>
                                <input
                                    type="text" name="imagen_principal" required
                            ...
                            <div className="col-span-2">
                                ...
                                <input
                                    type="text" name="imagenes" required
                                    value={formulario.imagenes.join(", ")}
                                    onChange={(e) =>
                                        setFormulario({
                                            ...formulario,
                                            imagenes: e.target.value.split(",").map(val => val.trim()),
                                        })
                                    }
                                    className="w-full bg-white p-2 outline-none rounded-md text-black"
                                />
                            ...
                            <div>
                                ...
                                <input
                                    type="text" name="seccion" required
                            ...
                            <div>
                                ...
                                <input
                                    type="text" name="productos_relacionados" required
                                    value={formulario.productos_relacionados.join(", ")} // mostrar
                                    onChange={(e) =>
                                        setFormulario({
                                            ...formulario,
                                            productos_relacionados: e.target.value.split(",").map(val => val.trim()),
                                        })
                                    }
                                    className="w-full bg-white p-2 outline-none rounded-md text-black"
                                />
                        ...
                        <div className="flex gap-2 mt-8">
                            <button type="submit" form="eliminentechno3" className="px-10 bg-teal-400 py-1 rounded-full text-lg hover:bg-teal-500">
