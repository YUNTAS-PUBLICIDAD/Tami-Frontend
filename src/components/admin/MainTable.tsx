              ...
              >
                ...
                <td className="px-2 lg:px-4 py-2">
                  <div className="flex justify-center gap-2">
                    <button
                      className="cursor-pointer p-2 text-red-600 hover:text-red-800 transition"
                      title="Eliminar"
                    >
                      <FaTrash size={16} />
                    </button>
                    <button
                      className="cursor-pointer p-2 text-green-600 hover:text-green-800 transition"
                      title="Confirmar"
                    >
                      <FaCheck size={16} />
                    </button>
